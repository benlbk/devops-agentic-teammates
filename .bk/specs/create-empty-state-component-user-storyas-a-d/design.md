# Design: Create Empty State Component
...
### Components
- **EmptyState** (component): Reusable component to display when no data is available
- **EmptyStateIcon** (component): Icon/illustration component for empty state
