...
| T-017 | **Implement RAG pipeline** — Codebase indexing service that embeds code files into OpenSearch. Incremental updates on push events. Semantic retrieval for agent context. | P1 | L | T-007, T-016 | ✅ Done (graceful degradation w/o OpenSearch) |
