# Design: Implement EmptyStateIcon component
...
### Components
- **EmptyStateIcon** (component): A reusable component for displaying empty state icons/illustrations that follows design system guidelines and is responsive
